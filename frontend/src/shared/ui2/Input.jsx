    ...
    return (
        ...
        <div className="w-full">
            ...
            <div className="relative h-12 flex items-center">
                ...
                <input type={type} className={`relative w-full h-12 rounded-md border px-4 text-base transition-colors focus:outline-none ${error ? "border-red-800 hover:border-red-800 focus:border-[3px] focus:border-red-800" : "border-border hover:border-(--primary-950) hover:border-2 focus:border-[3px] focus:border-(--primary-950)"}`} {...props} />
            {/* Cierra el contenedor relativo del input. */}
            </div>
