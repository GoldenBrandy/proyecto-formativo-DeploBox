...
export
/* Creamos userColumns como arreglo. Sirve para guardar listas de rutas, campos, usuarios, permisos u opciones. */
const userColumns = [
// Columna ID
{
  accessorKey: "id",
  // Propiedad del objeto user que se mostrará en la columna
...
// Columna Estado (activo / inactivo)
{
  ...
  cell: ({
    ...
    return (
      ...
      <Switch checked={user.is_active} // Estado actual del usuario
...
{
  id: "actions",
  // No usa accessorKey porque no corresponde a un campo del usuario
