...
export default
/* Esta funcion ReportConfigModal agrupa la logica de esta parte del proyecto. Recibe datos, los procesa y devuelve el resultado necesario. */
      ...
      {/* Contenedor del modal */}
       <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-lg">
        ...
        {/* Selección de formato */}
         <div className="mb-4">
           <Select label="Formato del reporte" value={format} onChange={e => setFormat(e.target.value)} options={[{
            label: "PDF",
            value: "pdf"
          }, {
            label: "Excel",
          ...
          {/* Grid de checkboxes */}
           <div className="grid grid-cols-2 gap-2">
            {userReportFields.map(field => {
              ...
              return <Checkbox key={field.key} // Key única para renderizado
        ...
        {/* Selección de alcance */}
         <div className="mb-4">
           <Select label="Alcance del reporte" value={scope} onChange={e => setScope(e.target.value)} options={[{
        ...
        {scope === "document" && <div className="mb-4">
             <Input label="Número de documento" value={documentNumber} onChange={e => setDocumentNumber(e.target.value)} placeholder="Ingrese número de documento" />
          </div>}
