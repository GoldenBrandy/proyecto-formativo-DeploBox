...
export default
/* Esta funcion UserFeatureButton agrupa la logica de esta parte del proyecto. Recibe datos, los procesa y devuelve el resultado necesario. */
function UserFeatureButton({
  children,
  type = "button",
  ...props
}) {
